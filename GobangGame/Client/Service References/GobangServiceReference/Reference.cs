...
namespace Client.GobangServiceReference {
    ...
    public interface IGobangService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="WcfGobangGameExample/IGobangService/SetDot")]
        System.Threading.Tasks.Task SetDotAsync(int index, int i, int j, int k);
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="WcfGobangGameExample/IGobangService/SetDot_1")]
        System.Threading.Tasks.Task SetDot_1Async(int index, int i, int j, int k, int i1, int j1);
    ...
    public partial class GobangServiceClient : System.ServiceModel.DuplexClientBase<Client.GobangServiceReference.IGobangService>, Client.GobangServiceReference.IGobangService {
        ...
        public void SetDot(int index, int i, int j, int k) {
            base.Channel.SetDot(index, i, j, k);
        }
        
        public System.Threading.Tasks.Task SetDotAsync(int index, int i, int j, int k) {
            return base.Channel.SetDotAsync(index, i, j, k);
        }
        
        public void SetDot_1(int index, int i, int j, int k, int i1, int j1) {
            base.Channel.SetDot_1(index, i, j, k, i1, j1);
        }
        
        public System.Threading.Tasks.Task SetDot_1Async(int index, int i, int j, int k, int i1, int j1) {
            return base.Channel.SetDot_1Async(index, i, j, k, i1, j1);
        }
