...
namespace Service
{
    public class GobangService : IGobangService
    {
        ...
        public void SetDot(int index, int row, int col,int k)
        {
            CC.Rooms[index].SetGridDot(row, col,k);
        }
        public void SetDot_1(int index, int row, int col,int k,int row1,int col1)
        {
            CC.Rooms[index].SetGridDot_1(row, col,k,row1,col1);
        }
